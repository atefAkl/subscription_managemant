...
<head>
    ...
    <title>تفاصيل طلب الاشتراك - نظام إدارة الاشتراكات</title>
...
<body class="bg-gray-100 min-h-screen">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <h1 class="text-xl font-bold text-blue-600">تفاصيل طلب الاشتراك</h1>
                    </div>
                </div>
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <x-breadcrumb :items="[
            ...
            ['label' => 'تفاصيل الطلب #' . $subscriptionRequest->id, 'url' => '']
        ]" />
            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <a href="{{ asset('storage/' . $subscriptionRequest->payment_receipt) }}" 
                               target="_blank"

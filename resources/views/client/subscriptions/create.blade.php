...
<head>
    ...
    <title>طلب اشتراك جديد - نظام إدارة الاشتراكات</title>
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <h1 class="text-xl font-bold text-blue-600">طلب اشتراك جديد</h1>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <select name="device_count" id="device_count" 
                                        class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    @for($i = 1; $i <= 10; $i++)
                                        <option value="{{ $i }}" {{ old('device_count') == $i ? 'selected' : '' }}>
                                            {{ $i }} {{ $i == 1 ? 'جهاز' : 'أجهزة' }}
                                        </option>
                                    @endfor
                                </select>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="date" name="proposed_start_date" id="proposed_start_date" 
                                       value="{{ old('proposed_start_date', date('Y-m-d')) }}"
                                       min="{{ date('Y-m-d') }}"
                                       class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>

...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            ...
            @endif">
                <div class="card-header px-2 py-2 text-center bg-primary">
                    <h3 class="text-lg font-bold text-gray-100 ">{{ $request->serial_number }}</h3>
                </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-4 flex justify-between">
                        <a href="{{ route('client.subscription-requests.show', $request->id) }}" class="text-green-600 hover:text-green-800 text-sm font-medium">
                            عرض التفاصيل
                        </a>
                        <x-delete-button :url="route('client.subscriptions.edit', $request->id)" class="text-blue-600 hover:text-blue-800 text-sm font-medium" label="تعديل " />
                        <x-delete-button :url="route('client.subscriptions.cancel', $request->id)" class="text-red-600 hover:text-red-800 text-sm font-medium"
                            label="الغاء الطلب" />
                        @if($request->status == 'quoted')
                        <a href="{{ route('client.subscription-requests.payment', $request->id) }}" class="text-green-600 hover:text-green-800 text-sm font-medium">
                            الدفع الآن
                        </a>
                        @endif
                    </div>

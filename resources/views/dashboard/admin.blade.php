...
<!-- Welcome Section -->
<div class="bg-gradient-to-r from-blue-600 to-purple-600 overflow-hidden shadow-xl rounded-lg mb-3">
    <div class="px-6 py-2 sm:p-10 text-white">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H3m2 0h3M9 7h6m-6 4h6m-2 4h2M9 15h2"></path>
                    </svg>
                </div>
            </div>
            <div class="mr-6">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 mb-8">
    ...
    <!-- Card 3: Packages Management -->
    <a href="{{ route('admin.packages.index') }}" class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 card-compact">
        <div class="py-2 px-6">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                ...
                <div class="text-right">
                    <div class="text-2xl font-bold text-green-600">{{ $totalClients ?? 0 }}</div>
                    <div class="text-xs text-gray-500">الباقات</div>
                </div>
            </div>
            <h3 class="font-bold text-gray-900 mb-1">إدارة الباقات</h3>
            <p class="text-gray-600 text-xs">الباقات المتاحة </p>
        </div>
    </a>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="py-2 px-6 bg-gradient-to-r from-green-500 to-blue-600">
        ...
        <div class="py-2 px-6">
            ...
            <div class="mt-4 pt-2 border-t">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.payments.pending') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
    ...
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="py-2 px-6 bg-gradient-to-r from-yellow-500 to-orange-600">
            <h3 class="text-lg font-medium text-white flex items-center">
            ...
            <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2 space-x-reverse">
                        <button onclick="quickVerify({{ $payment->id }})" class="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded text-xs transition-colors">
                            <i class="fas fa-check"></i>
                        </button>
                        <button onclick="viewPayment({{ $payment->id }})" class="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded text-xs transition-colors">
        ...
        <div class="bg-gray-50 px-6 py-3 text-center">
            <a href="{{ route('admin.payments.pending') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">

                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input 
                                        type="number" 
                                        class="form-control @error('device_limit') is-invalid @enderror" 
                                        id="device_limit" 
                                        name="device_limit" 
                                        value="{{ old('device_limit', 5) }}"
                                        min="1" 
                                        max="50"
                                        placeholder="عدد الأجهزة المسموحة"
                                        required>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        maxlength="1000">{{ old('client_notes') }}</textarea>
                                    <small class="text-muted">الحد الأقصى 1000 حرف</small>
                                    @error('client_notes')
                                        <div class="invalid-feedback d-block">
                                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}

    ...
    <div class="bg-white rounded shadow-sm mb-3 px-4 py-2 sm:px-6 flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                إدارة شاملة لجميع العملاء في النظام
            </p>
        </div>
            ...
            <form method="GET" action="{{ route('admin.clients.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="اسم العميل أو البريد الإلكتروني..."
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="7" class="px-6 py-8 text-center">
                        ...
                        <a href="{{ route('admin.clients.create') }}"
                            class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 active:bg-blue-600 disabled:opacity-25 transition">
                            <i class="fas fa-plus ml-1"></i>
                            إضافة عميل جديد
                        </a>
                    </td>
